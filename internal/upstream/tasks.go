...
// 来源：panel internal/upstream/tasks.go 快照拷贝 + 适配（2026-09-21）。
// 主仓库漂移处理：growthJSONMP 为 panel 私有底座，主仓库缺失——随文件移植（mp
// 口径 = BillingHeaders + X-Client-Platform: miniprogram，语义同 growthJSON）。
//
